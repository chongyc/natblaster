...
xcopy /v /Y %WINPCAPSOURCEDIR%\wpcap\libpcap\Win32\Include\Gnuc.h 		%WPDPACKDESTDIR%\Include\	>nul
...
xcopy /v /Y %WINPCAPSOURCEDIR%\Common\Devioctl.h			 	%WPDPACKDESTDIR%\Include\	>nul
xcopy /v /Y %WINPCAPSOURCEDIR%\Common\Ntddndis.h			 	%WPDPACKDESTDIR%\Include\	>nul
xcopy /v /Y %WINPCAPSOURCEDIR%\Common\Ntddpack.h			 	%WPDPACKDESTDIR%\Include\	>nul
